      ...
      <div className="mx-auto px-6 relative z-10">
        ...
        >
          <motion.div 
            ...
            className="inline-block px-4 py-2 mb-6 rounded-full bg-amber-100 dark:bg-amber-900/30 backdrop-blur-sm cursor-grab"
            variants={itemVariants}
          >
            <p className="text-amber-600 dark:text-amber-400 font-mono text-sm md:text-base font-medium">
              Hi, I'm Himanshu Chauhan 👋
            </p>
          </motion.div>

          <motion.h1
            className="text-5xl md:text-7xl lg:text-8xl font-bold text-gray-900 dark:text-white mb-6 bg-clip-text text-transparent bg-gradient-to-r from-amber-600 to-indigo-600 dark:from-amber-400 dark:to-indigo-400"
            variants={itemVariants}
          >
            Building Digital
            <br />
          ...
          >
              ...
              >
                <span className="px-4 py-2 rounded-full bg-white dark:bg-gray-800 shadow-sm text-sm font-medium flex items-center gap-2">
                  <FaReact className="text-amber-500" /> React
                </span>
              </motion.div>
              <motion.div 
                drag
              ...
              >
                <span className="px-4 py-2 rounded-full bg-white dark:bg-gray-800 shadow-sm text-sm font-medium flex items-center gap-2">
                  <SiTypescript className="text-amber-600" /> TypeScript
                </span>
              </motion.div>
              <motion.div 
                drag
              ...
              >
                <span className="px-4 py-2 rounded-full bg-white dark:bg-gray-800 shadow-sm text-sm font-medium flex items-center gap-2">
                  <SiGraphql className="text-amber-600" /> GraphQL
                </span>
              </motion.div>
              <motion.div 
                drag
              ...
              >
                <span className="px-4 py-2 rounded-full bg-white dark:bg-gray-800 shadow-sm text-sm font-medium flex items-center gap-2">
                  <FaDatabase className="text-amber-600" /> MongoDB
                </span>
              </motion.div>
          </motion.div>
          ...
          >
            {socialLinks.map((social, index) => (
              <motion.a
                ...
                className="w-12 h-12 flex items-center justify-center rounded-full bg-white dark:bg-gray-800 shadow-sm hover:shadow-md text-gray-600 dark:text-gray-300 hover:text-amber-600 dark:hover:text-amber-400 transition-all duration-300"
